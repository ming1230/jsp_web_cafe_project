      ...
      <div style="width: 70%;">
      	<div>
	      	<div style="width: 80%; margin-bottom:20px;">
				...
				<button type="button" class="btn btn-outline-dark" style="float: right" onclick="location.href='Main.jsp'">목록</button>	      
      	</div>
      	...
      	<div style="width: 80%">
	            ...
	            <div class="form-floating">
	               <div style="border: 1px solid; border-radius:5px; padding: 10px; height:500px;">공지사항</div>
	            </div>
      	</div>
	  </div>
	</div>
