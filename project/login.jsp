...
<body style="background-color: #ededed;">
	<div class="loginbox" style=" width: 780px; height: 450px; margin: 0 auto; ">
		...
		<form action="#" style=" width: 100%; height: 450px; background-color: #fff;  padding: 50px; box-sizing: border-box; border-radius: 50px">
			<fieldset style="border: none;">
				...
				<div style="text-align:center;">
					...
					<label for="remeber-check">로그인 저장</label>
				</div>
			</fieldset>
		</form>
	</div>
